...
$to_email = "moorej22@tcnj.edu"; // put your email address here - this is the address to which the email will be sent

// Check if the "from" input field is filled out
if (isset($_GET["from"]) && validateEmail($_GET["from"])) {
			
	$from = $_GET["from"]; // sender
	$subject = $_GET["subject"]; // email subject
	$message = $_GET["message"]; // email text message
	$callback = $_GET["callback"]; // javascript callback function
